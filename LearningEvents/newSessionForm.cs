            ...
            if (radioButton2.Checked)
            {
                if (coursecodearray.Contains(courseCode.Text))
                {
                    ...
                    try
                    {
                        ...
                        System.IO.File.WriteAllText("L:\\Config\\courses.txt", coursesString);
                    }
            ...
            try
            {
                foreach (string i in filearray)
                {
                    if (i == "index.html")
                    {
                        ...
                        //string for a new link with the file extension removed in the diplayed text
                        indexString += "<li><a href=\"" + i + "\" target=\"_blank\">" + i.Remove(i.Length - 4) + "</a></li>";
                    }
                }
                //check if link 1 has a value
                if(link1.Text.Length > 0 || link1name.Text.Length > 0)
                {
                    //Check if link name was entered for link 1
                    if (link1name.Text.Length > 0)
                    {
                        //Add the link to index.html
                        indexString += "<li><a href=\"" + link1.Text + "\" target=\"_blank\">" + link1name.Text + "</a></li>";
                    }
                    else
                    {
                        //No Text entered for Link 1
                        MessageBox.Show("You did not enter a text value for Link 1.  Please enter a value.");
                    }
                    /*  To add later : If link has text but no URL
                    //Check if link 1 url was entered
                    ...
                    {
                        //No URL entered for Link 1
                        MessageBox.Show("You did not enter a URL value for Link 1.  Please enter a value.");
                    }
                    */
                }
            
                //Check if link 2 has a value
                if (link2.Text.Length > 0 || link2name.Text.Length > 0)
                {
                    //Check if link name was entered for link 1
                    if (link2name.Text.Length > 0)
                    {
                        //Add the link to index.html
                        indexString += "<li><a href=\"" + link2.Text + "\" target=\"_blank\">" + link2name.Text + "</a></li>";
                    }
                    else
                    {
                        //No Text entered for Link 2
                        MessageBox.Show("You did not enter a text value for Link 2.  Please enter a value.");
                    }
                    /*  To add later : If link has text but no URL
                    //Check if link 2 url was entered
                    ...
                    {
                        //No URL entered for Link 1
                        MessageBox.Show("You did not enter a URL value for Link 2.  Please enter a value.");
                    }
                    */
                }

                //Check if link 3 has a value
                if (link3.Text.Length > 0 || link3name.Text.Length > 0)
                {
                    //Check if link name was entered for link 3
                    if (link3name.Text.Length > 0)
                    {
                        //Add the link to index.html
                        indexString += "<li><a href=\"" + link3.Text + "\" target=\"_blank\">" + link3name.Text + "</a></li>";
                    }
                    else
                    {
                        //No Text entered for Link 3
                        MessageBox.Show("You did not enter a text value for Link 3.  Please enter a value.");
                    }
                    /*  To add later : If link has text but no URL
                    //Check if link url was entered
                    if (link3.Text.Length > 0)
                    {
                        //Add the link to index.html
                        indexString += "<li><a href=\"" + link3.Text + "\" target=\"_blank\">" + link3name.Text + "</a></li>";
                    }
                    ...
                    {
                        //No URL entered for Link 3
                        MessageBox.Show("You did not enter a URL value for Link 3.  Please enter a value.");
                    }
                    */
                }
            }
